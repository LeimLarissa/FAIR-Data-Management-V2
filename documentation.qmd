...
-   What research is this dataset connected to?\
    -   Indicated on dataset level only by similarity with the paper title.
    -   <https://doi.org/10.1515/auto-2019-0027> (Available in the dataset's metadata on Zenodo)
-   Can this dataset be reused?\
...
-   More about code related documentation can be found under [Good Scientific Practice for Research Software Engineering](https://gwp-rse-ff130b.pages.gwdg.de/en/faqs/doc/)
:::
